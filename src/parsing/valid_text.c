...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/11/08 22:40:03 by iidkhebb          #+#    #+#             */
/*   Updated: 2022/11/08 22:41:40 by iidkhebb         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	valid_texture(char *line)
{
	...
	if (!line)
		return (-1);
	if (ft_strchr(TEXTURES_KEYS, line[i]) && \
		ft_strchr(AFTER_KEY, line[i + 1]) && line[i + 2] == ' ')
